...
public class MainWindowController {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> lockTableViewIndexColumn;
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> lockTableViewValueColumn;
    ...
    public void initialize() {
        ...
        lockTableViewIndexColumn.setCellValueFactory(
                cellData -> new SimpleStringProperty(Integer.toString(cellData.getValue().getKey())));
        lockTableViewValueColumn
                .setCellValueFactory(
    ...
    private void populateLockTable() {
        MyILock lockTable = controller.getPrgStates().get(0).getLockTable();
        ObservableList<Map.Entry<Integer, Integer>> lockTableEntries = FXCollections
                .observableArrayList(lockTable.getContent().entrySet());
