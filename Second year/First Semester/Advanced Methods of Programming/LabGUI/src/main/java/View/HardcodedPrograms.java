        ...
        public static List<IStmt> getPrograms() {
                return new ArrayList<>(List.of(
                                ...
                                new CompStmt(
                                                ...
                                                new CompStmt(
                                                                new AssignStmt("varf",
                                                                                new ValueExp(new StringValue(
                                                                                                "test.in"))),
                                                                new CompStmt(
                                                                                new OpenRFileStmt(new VarExp("varf")),
                                                                                new CompStmt(
                                                                                                new VarDeclStmt("varc",
                                                                                                                new IntType()),
                                                                                                new CompStmt(
                                                                                                                new ReadFileStmt(
                                                                                                                                new VarExp("varf"),
                                ...
                                new CompStmt(
                                                ...
                                                new CompStmt(
                                                                ...
                                                                new CompStmt(
                                                                                new VarDeclStmt("a", new RefType(
                                                                                                new RefType(new IntType()))),
                                                                                new CompStmt(
                                                                                                new NewStmt("a", new VarExp(
                                                                                                                "v")),
                                                                                                new CompStmt(
                                                                                                                new PrintStmt(new VarExp(
                                                                                                                                "v")),
                                                                                                ...
                                                                                                new CompStmt(
                                                                                                                ...
                                                                                                                new CompStmt(
                                                                                                                                ...
                                                                                                                                new PrintStmt(new ReadHeapExp(
                                                                                                                                                new VarExp("a")))))))))
                // ,
                // Failing Program Example (Program 11):
                // int x;
                // x = true; // Type mismatch
                // new CompStmt(
                // new VarDeclStmt("x", new IntType()),
                // new AssignStmt("x", new ValueExp(new BoolValue(true))) // This line will
                // cause a type error
                // )
                ));
        }
